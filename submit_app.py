...
Please gather the following information from the call recording regarding the final expense application:

1. Was an application submitted?
2. Did the customer provide the agent with a routing number and account number?
3. Did the customer provide the agent with a credit card number?
4. What is the name of the insurance carrier?
5. What is the monthly premium amount?
6. What is the coverage amount?
7. What is the date of the first payment?
8. If no application was submitted, was a follow-up appointment set?

**Example Response:**

- **Application Submitted:** Yes
- **Routing and Account Number Provided:** Yes
- **Credit Card Number Provided:** No
- **Carrier:** AIG
- **Monthly Premium:** $87.05
- **Coverage Amount:** $5,000
- **First Payment Date:** 7/10/24
- **Follow-up Appointment Set:** n/a
    """
