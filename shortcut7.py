...
def analyze_transcript_with_chatgpt(transcript):
    ...
    2. Did the customer purchase a policy?
    3. If Yes, then provide the following information:
       - Customer Email
       - Customer Address
       - Date of Birth
       - Customer Age
       ...
       - Credit Card exp date (if applicable)
       - Credit Card CVV Code (if applicable)
       - Customer Medical Conditions
       - Any other additional notes from the call
    """
