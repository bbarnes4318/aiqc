...
def analyze_transcript_with_chatgpt(transcript):
    ...
    1. Where does the prospect live? 
    2. Does the prospect live in a home, apartment, hotel, with others?
    3. Does the prospect live inside of a jail or prison?
    4. Does the prospect live in Lackawanna prison?
    """
