...
def analyze_transcript_with_chatgpt(transcript):
    ...
    2. Did the agent ask for the prospect's phone number and tell them they will call them back?
    3. What coverage amount was quoted?
